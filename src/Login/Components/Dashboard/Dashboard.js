      ...
      <main>
        ...
        >
          <Container maxWidth="sm">
            ...
            Welcome to SKCET!! Sri Krishna College of Engineering and Technology is the most sought after Institution among the premier technical Institutions in South India. Since its establishment in the year 1998, the Institution has marched towards the pinnacle of glory through its remarkable achievements in the field of Engineering Education.
            </Typography>
            <Stack
              sx={{ pt: 4 }}
              direction="row"
            ...
            >
              ...
              <Button variant="text">Online Payment</Button>
            </Stack>
          </Container>
        </Box>
